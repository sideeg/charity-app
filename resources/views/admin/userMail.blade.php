...
@section('content')
        <div class="dashboard-wrapper">
        	 ...
        	 <form action="{{route('mail.store')}}" method="POST"  enctype="multipart/form-data" autocomplete="off">
        	 	   @csrf
            ...
            <div class="row m-b-20">
               <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                  <div class="page-title">
                     <h3 class="col-black">  Send Email  </h3>
                  </div>
               </div>
            </div>
            <div class="block-element">
               <div class="box-type1  notify">
                  <h5 class="basic-info-c">Send Email </h5>
                  <div class="row">
                     <div class="col-md-12">
...
Description (Ar) "name="description_ar"  value="{{old('description_ar')}}"    rows="5" cols="10"></textarea>
                        ...
                        <!--    <div class="form-check">
                              <input class="form-check-input" type="radio" name="platform"  value="ios" required="">
                              <label class="form-check-label" for="flexRadioDefault1">
                              IOS
                              </label>
                               <input class="form-check-input" type="radio"  name="platform"  value="android">
                              <label class="form-check-label" for="flexRadioDefault1">
                               Android
                              </label>
                                  <input class="form-check-input" type="radio"  name="platform"  value="all">
                              <label class="form-check-label" for="flexRadioDefault1">
                               All
                              </label>
                            </div> -->
...
<!-- testing -->
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6">
                          ...
                          <!--  <div class="form-check">
                              <input class="form-check-input" type="radio" name="user" value="initiator" required="">
                              <label class="form-check-label" for="flexRadioDefault1">
                              Initiator
                              </label>
                               <input class="form-check-input" type="radio" name="user" value="contributor">
                              <label class="form-check-label" for="flexRadioDefault1">
                               Contributor
                              </label>
                              <input class="form-check-input" type="radio" name="user" value="all">
                              <label class="form-check-label" for="flexRadioDefault1">
                               All users
                              </label>
                            </div> -->
    ...
    <label class="radio-inline">
      ...
      <div class="clab"> All users</div>
                   ...
                   <div class="block-element text-right">
                         ...
                         <button class="btn-c  cancel  reset" type="button" onclick="window.location.href='{{url('admin/bulk-emails')}}'">  Cancel </button>
