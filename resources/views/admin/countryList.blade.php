            ...
            <div class="row m-b-20">
               <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12">
                  <div class="page-title">
                     <h3 class="col-black"> Countries </h3>
                  </div>
               </div>
               <div class="col-md-10 col-lg-10 col-sm-12 col-xs-12 ">
                  <div class="right-side-c country-d">
                     <div class="date-sec  custom-c34">
                        ...
                        <span class="cal-icon icon-d custom-c2  gh">
                           <img src="{{asset('images/img-1/regresh-icon-1.png')}}" id="country_filter"></i>
                        </i>
                        </span>
                         <span class="cal-icon icon-d custom-c2  gh">
                        ...
                        <a href="{{url('admin/country/create')}}" class="btn btn-primary btn-sm add-nh" role="button"> Add New</a>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="box-type1">
                  ...
                  <div class="row">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table-type2" id="countries" style="width:100%">
                           <thead>
                              <tr>
                                 <th> Id</th>
                                 <th>Name</th>
