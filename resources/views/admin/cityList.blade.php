                     ...
                     <div class="date-sec  custom-c34">
                           ...
                           <label>Country</label> 
                              <select class="form-control" id="country" name="country">
                                 ...
                                 @foreach($country as $key => $value)
                                  <option  value="{{$value->id}}"  data-id="{{$value->id}}">{{$value->title}}</option>
                                 @endforeach
                              </select>                     
                        </span>
                      ...
                      <div class="address-h">
                           ...
                           <label>State</label> 
                              <select class="form-control" id="city" name="state">
                                 ...
                                 @foreach($state as $key => $value)
                                  <option  value="{{$value->id}}" data-id="{{$value->countrie_id}}" data-country="{{$value->countrie_id}}">{{$value->title}}</option>
                                 @endforeach
                              </select>                     
                        </span>
                        ...
                        <span class="cal-icon icon-d custom-c2  gh">
                           <img src="{{asset('images/img-1/regresh-icon-1.png')}}" id="city_filter"></i>
                        </i>
                        </span>
                         <span class="cal-icon icon-d custom-c2  gh">
                        ...
                        <a href="{{url('admin/city/create')}}" class="btn btn-primary btn-sm add-nh" role="button"> Add New</a>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="box-type1">
                  ...
                  <div class="row">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table-type2" id="cities" style="width:100%">
                           <thead>
                              <tr>
                                 <th> Id</th>
                                  <th>Country</th>
