...
@section('content')
        <div class="dashboard-wrapper">
        	 ...
        	 <form action="{{route('city.store')}}" method="POST"  enctype="multipart/form-data" autocomplete="off">
        	 	   @csrf
            ...
            <div class="block-element">
               <div class="box-type1  notify">
                  <h5 class="basic-info-c">Add City</h5>
                  <div class="row">
                     <div class="col-md-12">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6">
                           ...
                           <div class="form-field1 m-b-20">
                              <input type="text" class="form-control" placeholder=" Name "name="title" pattern="[a-zA-Z\s]+" oninvalid="setCustomValidity('Please add in this field and Please enter  alphabets only.')" onkeypress="return /[a-zA-Z\s]+/i.test(event.key)" onkeydown="try{setCustomValidity('')}catch(e){}" required >
                           </div>
                        </div>
