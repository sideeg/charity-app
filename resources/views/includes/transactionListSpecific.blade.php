...
@section('content')
<div class="dashboard-wrapper">  <div class="page-title">
                     <h3 class="col-black all transaction"> All Transaction </h3>
                  </div></div>
               ...
               <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12 ">
                  <div class="right-side-c"> 
                     <div class="date-sec  custom-c34">
                        ...
                        <span>
                             <a href="{{route('case.show',$id)}}" class="btn btn-primary btn-sm  " role="button" aria-disabled="true">Go Back</a>
                        </span>
 ...
 $("#transaction_case").DataTable({
            ...
            { data: 'status', name: 'status' , "render": function (data, type, full, meta) {
               ...
               { data: 'status', name: 'status' , "render": function (data, type, full, meta) {
                       if( data == 0)
                       {
                           return '<label class="switch"><input type="checkbox" checked onclick="activate_transaction('+full.id+')" id="custoner_checkbox"><span class="slider round"></span></label>'; 
                       }
                       else
                       {
