            ...
            <div class="row m-b-20 case_list">
               <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12">
                  <div class="page-title">
                     <h3 class="col-black"> Push Notifications List </h3>
                  </div>
               </div>
               <div class="col-md-10 col-lg-10 col-sm-12 col-xs-12 ">
                  <div class="right-side-c country-d  states-d city-list-sec">
                   ...
                   <!--      <span class="cal-icon icon-d custom-c2">
                         ...
                         <a href="{{url('admin/push-notifications')}}" class="btn btn-primary btn-sm add-nh" role="button"> Add New</a>
                     </div>
                      </div>
                  </div>
               </div>
               ...
               <div class="box-type1">
                  ...
                  <div class="row">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table-type2" id="bulk_push" style="width:100%">
                           <thead>
                              <tr>
