  ...
  <div class="dashboard-wrapper">
            <div class="row m-b-20">
               <div class="col-md-2 col-lg-2 col-sm-12 col-xs-12">
                  <div class="page-title">
                     <h3 class="col-black"> Initiators </h3>
                  </div>
               </div>
               <div class="col-md-10 col-lg-10 col-sm-12 col-xs-12 ">
                  <div class="right-side-c  country-d  states-d city-list-sec">
                     ...
                     <div class="date-sec custom-c34">
                        ...
                        <span class="cal-icon icon-d  custom-c2 iconhh"><img src="{{asset('images/img-1/regresh-icon-1.png')}}" id="provider_filter"></i>
                        </i>
                        </span>
                        ...
                        <a href="{{url('admin/initiator/create')}}" class="btn btn-primary btn-sm add-nh" role="button"> Add New</a>
            ...
            <div class="block-element">
               <div class="box-type1">
                  ...
                  <div class="row">
                     <div class="table-overlay  table-responsive">
                        <table class="table-type2" id="provider">
                           <thead>
                              <tr>
