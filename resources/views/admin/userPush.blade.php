...
@section('content')
        <div class="dashboard-wrapper">
        	 ...
        	 <form action="{{route('push.store')}}" method="POST"  enctype="multipart/form-data" autocomplete="off">
        	 	   @csrf
            ...
            <div class="row m-b-20">
               <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                  <div class="page-title">
                     <h3 class="col-black">  Send Push Notification  </h3>
                  </div>
               </div>
            </div>
            <div class="block-element">
               <div class="box-type1  notify">
                  <h5 class="basic-info-c">Send Push </h5>
                  <div class="row">
                     <div class="col-md-12">
                  ...
                  <div class="row">
                      <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6">
                           ...
                           <div class="form-field1 m-b-20">
                              <input type="text" class="form-control" placeholder="Please Enter a Title (En) "name="title" pattern="[a-zA-Z0-9\s]+"  oninvalid="setCustomValidity('Please enter on Numbers or alphabets only. ')" onchange="try{setCustomValidity('')}catch(e){}"  value="{{old('title')}}"   >
                           </div>
                        </div>      
    ...
    <label class="radio-inline">
      ...
      <div class="clab"> All users</div>
                   ...
                   <div class="block-element text-right">
                         ...
                         <button class="btn-c  cancel  reset" type="button" onclick="window.location.href='{{url('admin/bulk-push-notifications')}}'">  Cancel </button>
